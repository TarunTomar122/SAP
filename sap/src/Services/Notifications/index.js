...
class NotificationService {
    init = (registerHandler, onNotification) => {
    ...
    async configure(onNotification) {
        const onRegister = this.handleRegister;
        PushNotification.configure({
            onNotification: function (notification) {
                // console.log("I am here");
                // NavigationService.navigate("ProfileFlow");
                // const { data } = notification;
                // console.log("Here I am ", notification.data.roomId);
                // if (notification.data.roomId) {
                //   const counterPart = notification.data.counterPart;
                //   const counterPartId = notification.data.counterPartId;
                //   const counterPartAvatar = notification.data.counterPartAvatar;
                //   const roomId = notification.data.roomId;

                //   NavigationService.navigate("PermanentChatScreen", {
                //     dedicatedChat: true,
                //     counterPart,
                //     counterPartId,
                //     counterPartAvatar,
